...
(assert (exists ((x (Ref dll_t)) (n (Ref dll_t)) (b (Ref dll_t))) 
            (sep (pto x (dll_cons n b))
                 (dllseg_plus_rev a (as nil (Ref dll_t)) b (as nil (Ref dll_t)))
                 (dllseg_plus n x c (as nil (Ref dll_t))))
        )
)
(assert (not (dllseg_plus_rev a (as nil (Ref dll_t)) c (as nil (Ref dll_t)))))
